...
from mudio.operations import op_overwrite, op_append
import tempfile
import shutil
import logging
...
def test_process_batch_basic(temp_audio_dir):
    ...
    result = process_batch(
        temp_audio_dir,
        operations={'title': op_overwrite('title', 'New Title')},
        fields=['title'],
        dry_run=True
    )
...
def test_process_batch_with_filters(temp_audio_dir):
    ...
    result = process_batch(
        temp_audio_dir,
        operations={'title': op_overwrite('title', 'Filtered Title')},
        fields=['title'],
...
def test_process_batch_force_parameter(temp_audio_dir):
    ...
    result = process_batch(
        temp_audio_dir,
        operations={'title': op_overwrite('title', 'Forced Title')},
        fields=['title'],
        force=True,
        dry_run=True
    )
